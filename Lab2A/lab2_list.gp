...
#
# output:
#	mlab2_list-1.png ... cost per operation vs threads and iterations
#	mlab2_list-2.png ... threads and iterations that run (un-protected) w/o failure
#	mlab2_list-3.png ... threads and iterations that run (protected) w/o failure
#	mlab2_list-4.png ... cost per operation vs number of threads
#
# Note:
