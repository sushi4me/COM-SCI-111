...
#
# output:
#	mlab2_add-1.png ... threads and iterations that run (unprotected) w/o failure
#	mlab2_add-2.png ... cost per operation of yielding
#	mlab2_add-3.png ... cost per operation vs number of iterations
#	mlab2_add-4.png ... threads and iterations that run (protected) w/o failure
#	mlab2_add-5.png ... cost per operation vs number of threads
#
# Note:
